...
{
	/// <summary>
	/// Responsible for generating the output file contents with requested versioning attributes and some helpfule comments.
	/// </summary>
	public static class AssemblyInfoFileCreator
	{
		...
		{
			return @"
// NB! this file is automatically generated on each build. Safe to delete or to ignore from source control.
// Check Properties/Nortal.Utilities.AssemblyVersioning.props file for other available algorithms and supported attributes.
