...
NB! if you are upgrading from v0.9 or older version, note that properties location has changed from "_tools" folder to conventionally already existing "Properties" folder!
